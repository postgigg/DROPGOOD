...
export const seoPages: Record<string, SEOConfig> = {
  ...
  booking: {
    ...
    canonical: 'https://dropgood.co/book',
  ...
  donationCenters: {
    ...
    canonical: 'https://dropgood.co/donation-centers',
  ...
  forCompanies: {
    ...
    canonical: 'https://dropgood.co/for-companies',
  ...
  companySignup: {
    ...
    canonical: 'https://dropgood.co/company-signup',
  ...
  joinCompany: {
    ...
    canonical: 'https://dropgood.co/join-company',
  ...
  tracking: {
    ...
    canonical: 'https://dropgood.co/track',
  ...
  receipt: {
    ...
    canonical: 'https://dropgood.co/receipt',
  ...
  confirmation: {
    ...
    canonical: 'https://dropgood.co/confirmation',
  },
};
...
export const citySEO: Record<string, CitySEOConfig> = {
  'richmond-va': {
    ...
    canonical: 'https://dropgood.co/donate/richmond-va',
  ...
  'austin-tx': {
    ...
    canonical: 'https://dropgood.co/donate/austin-tx',
...
export function generateCitySEO(cityName: string, stateCode: string, stateName: string): CitySEOConfig {
  return {
    ...
    canonical: `https://dropgood.co/donate/${cityName.toLowerCase().replace(/\s+/g, '-')}-${stateCode.toLowerCase()}`,
  };
}
