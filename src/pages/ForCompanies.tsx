...
import { Package, ArrowRight, Building2, Heart, TrendingUp, Users, Target, Zap, CheckCircle, Sparkles, DollarSign } from 'lucide-react';
          ...
          <div className="mt-16 sm:mt-24 md:mt-32 bg-gradient-to-br from-gray-800 to-gray-800/50 rounded-2xl sm:rounded-3xl p-6 sm:p-12 md:p-16 border border-gray-700">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-gray-900 border-2 border-blue-500 rounded-xl p-8 text-center">
                ...
                <button
                  onClick={() => navigate('/company-signup')}
                  className="bg-blue-600 text-white px-8 py-4 rounded-xl text-lg font-bold hover:bg-blue-700 transition w-full"
                >
                  Start for free
                </button>
              </div>
